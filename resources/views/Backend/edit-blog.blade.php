...
@section('content')
    <div class="edit-blog-form">
        ...
        <form action="" method="post" class="form" enctype="multipart/form-data">
            ...
            <div class="row gy-4 mt-1">
                <div class="col-lg-9 col-md-6">
                    <textarea name="article" id="article" cols="30" rows="5" class="form-control" value="{{ $blog->article }}"></textarea>
                    <div class="validate"></div>
                </div>
            ...
            <div class="mt-4 "><button type="submit" class="btn btn-primary">Update Blog</button></div>
        </form>
    </div>
@endsection
